...
#############################
def chop_gw_ir_2016(station,remove_60Hz_slope_output):
    ...
    gw_time=remove_60Hz_slope_output[0][1:gw_ir_ref+100]
    gw_data=remove_60Hz_slope_output[1][1:gw_ir_ref+100]
